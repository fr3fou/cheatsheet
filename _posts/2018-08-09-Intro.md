...
### If something isn't working right, remove the `.cat` (model) after the req.body! You can `console.log(req.body)` and `console.log(req.body.cat)` to make sure which is the correct one!
